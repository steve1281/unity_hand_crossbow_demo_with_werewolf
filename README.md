...
# Dev Log
<pre style="background-color: #1a1a1a; color: #ffffff; padding:15px; margin:5px">
* 24739ca - misc update (Steve Falcigno, 7 minutes ago)
* 1900145 - add audio (crossbow) to game. (Steve Falcigno, 4 hours ago)
* 93a9a73 - bug fix: UI Score for NONVR not updating (Steve Falcigno, 6 hours ago)
* efd520c - hybrid VR and Non VR (Steve Falcigno, 26 hours ago)
* d45f267 - fire bolts from the crossbow (Steve Falcigno, 30 hours ago)
* ed4aacb - add crossbow model to VR Player (Steve Falcigno, 30 hours ago)
* 789e40d - ammo bundles working in VR and fix UI for VR (Steve Falcigno, 31 hours ago)
* fbe9ca4 - Establish Terrain as teleportable (Steve Falcigno, 2 days ago)
* 79ff0ca - Establish teleportable areas (Steve Falcigno, 2 days ago)
* 9013d3a - Adjust EventSystem to allow VR UI (Steve Falcigno, 2 days ago)
* c6d7dbf -  add basic VR to game (Steve Falcigno, 2 days ago)
* 23364f6 - minor updates (Steve Falcigno, 2 days ago)
* e6d8440 - add Main and Game Scenes. Fix Player position. (Steve Falcigno, 3 days ago)
* e239bfc - add blood cloud particle, add transition from bad guy to werewolf and wolf (Steve Falcigno, 4 days ago)
* 884002b - have gamemanager spawn in bad guys (Steve Falcigno, 4 days ago)
* d7a7815 - add WolfDie behavior, modify WolfController to allow hits and hit points, add an ammobundle, and remove Apply Root Motion (Steve Falcigno, 5 days ago)
* 8dcadec - create werewolf and wolf prefabs (Steve Falcigno, 5 days ago)
* cc1f1b1 - create werewolf and wolf prefabs (Steve Falcigno, 5 days ago)
* 1f6d69b - add werewolf model, adjust to use NPC controller (Steve Falcigno, 6 days ago)
* 6d33f15 - re-add corrected animations (see notes), intergrate plant tree animation as example, toggle Tool on and off so no crossbow when planting tree (Steve Falcigno, 6 days ago)
* d76c843 - rename folder, add animation refinements for wolf (Steve Falcigno, 7 days ago)
* 767235d - add some polygons for variety (Steve Falcigno, 8 days ago)
* ac26871 - add score update logic (Steve Falcigno, 8 days ago)
* dc1e15b - add update ammo logic (Steve Falcigno, 8 days ago)
* 9dcdc90 - add UI Canvas Controller singleton to allow setting score and ammo. TMP Mesh imported (Steve Falcigno, 8 days ago)
* 9f9c94f - add ammo count (Steve Falcigno, 8 days ago)
* 0be136a - pickup ammo - initial test code (Steve Falcigno, 9 days ago)
* 8ec5179 - add tag Ammo, create AmmoBundle prefab, put one in the scene (Steve Falcigno, 9 days ago)
* ee85136 - add weapon fireing animation (Steve Falcigno, 9 days ago)
* 4721292 - add weapon firing to player, remove bolt test code from game manager (Steve Falcigno, 9 days ago)
* 46f8b33 - add a weapon to player (Steve Falcigno, 9 days ago)
* 5381c6f - add and use an animator (Steve Falcigno, 9 days ago)
* 0bc1cf6 - add a reticle, a 5x5 image (Steve Falcigno, 9 days ago)
* ee14900 - playerscript, basic movement controls (Steve Falcigno, 9 days ago)
* d424776 - add player model (Steve Falcigno, 10 days ago)
* 60d0794 - add game manager script, add a launch of a bolt, have it hit and death the bad guy (Steve Falcigno, 10 days ago)
* d3cd44f - add game manager script, add a launch of a bolt, have it hit and death the bad guy (Steve Falcigno, 10 days ago)
* 8d6c1b8 - add behaviours death and reset hit; add a gamemanager for testing, add a bolt tag (Steve Falcigno, 10 days ago)
* d9f64ad - create a projectile script (Steve Falcigno, 11 days ago)
* bc437d3 - update animation to include a bow shot (Steve Falcigno, 11 days ago)
* 69f0293 - add crossbow to bad guy (Steve Falcigno, 11 days ago)
* e957b95 - create crossbow prefab (Steve Falcigno, 11 days ago)
* f5dc2ee - add glft models (Steve Falcigno, 12 days ago)
* dd4dfe7 - set ground to green (Steve Falcigno, 12 days ago)
* f4082a9 - setup environment (ground, camera position) (Steve Falcigno, 12 days ago)
* 2990932 - grab some models, set up some color mats (Steve Falcigno, 12 days ago)
* e49c695 - init git (Steve Falcigno, 12 days ago)
</pre>
